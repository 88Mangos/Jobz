...
## Home Page Notes Dump 
just an editable note that I can dump things into (not associated with any specific table, should probably support Markdown formatting and pasting in code, including Python triple-quoted docstrings, without breaking anything)
